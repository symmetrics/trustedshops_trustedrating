...
*** F: According to the language set in shop, the widget belonging to it is loaded.
       Attention: the TrustedRating language must be the same as the shop language.
